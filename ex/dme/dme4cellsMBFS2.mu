...
mu bool R1(State t)
  ...
  (exists State s. 
    (TransCell(s.e_2, s.e_1, t.e_1, s.e_4) &
      (t.e_2 = s.e_2 & t.e_3 = s.e_3 & t.e_4 = s.e_4)) assume Reachable(s) &
    R1(s));
...
mu bool R2(State t)
  ...
  (exists State s. 
    (TransCell(s.e_3, s.e_2, t.e_2, s.e_1) &
      (t.e_1 = s.e_1 & t.e_3 = s.e_3 & t.e_4 = s.e_4))  assume Reachable(s)&
    R2(s));
...
mu bool R3(State t)
  ...
  (exists State s. 
    (TransCell(s.e_4, s.e_3, t.e_3, s.e_2) &
      (t.e_1 = s.e_1 & t.e_2 = s.e_2 & t.e_4 = s.e_4))  assume Reachable(s)&
    R3(s));
...
mu bool R4(State t)
  ...
  (exists State s. 
    (TransCell(s.e_1, s.e_4, t.e_4, s.e_3) &
      (t.e_1 = s.e_1 & t.e_2 = s.e_2 & t.e_3 = s.e_3))  assume Reachable(s)&
    R4(s));
