...
BEGIN {
  ...
  print "#print \""
  print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
  print "% this is the famous scheduler of Milner with no further optimizations      %"
  ...
  print ""
  print "bool Sched(Action a, SchedState s, SchedState t) a ~+ s"
  ...
  print "  exists Action a. Sched(a,s,t);"
  print ""
