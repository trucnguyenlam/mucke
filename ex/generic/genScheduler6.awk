...
function parallel(from, to,   start, end) {
  ...
  print "bool sched" from "to" to "(Action a, SchedState s, SchedState t) a ~+ s"
  if(from<end)
...
BEGIN {
  ...
  print "#print \""
  print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
  print "% this is the famous scheduler of Milner with forward reachability ana  %"
  print "% (uses a seperate Predicate for both forall quantors in bisimulates)   %"
  print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
  print "\";"
  print "#print;"
  print "#print \"=>  " N "  schedulers  <=\";"
  print "#print;"
  print ""
  ...
  print "  1;"
  print ""
  print "bool TransOfStarter(Action a, SchedState s, SchedState t) a ~+ s"
  print "  s.starter = start &"
  ...
  for(i=0; i<N; i++) {
  n=(i+1)%N;
  print "bool TransOfController" i "(Action a, SchedState s, SchedState t) a ~+ s"
  print "  s.controllers[" i "] = start &"
  ...
  print ""
  print "bool _Sched(Action a, SchedState s, SchedState t) a ~+ s"
  print "  SchedNonProjected(a,s,t) &"
  for(i=0; i<N; i++)
    print "  a.action != c" i " &"
  print "1;"
  print ""
  print "bool SchedWithoutAction(SchedState s, SchedState t)"
  print "  exists Action a. _Sched(a,s,t);"
  print ""
  print "mu bool ReachableSched(SchedState s)"
  print "  StartOfSched(s) |"
  print "  (exists SchedState t. SchedWithoutAction(t, s) & ReachableSched(t));"
  print ""
  print "#onsetsize ReachableSched;"
  print "#print \"(the number of reachable states should be " N*3*2**(N-1)+1 ")\";"
  print "#print;"
  print ""
  print "bool Sched(Action a, SchedState s, SchedState t)"
  print "  _Sched(a,s,t) assume ReachableSched(s);"
  print ""
  print "#size _Sched;"
  print "#size Sched;"
  print "#print;"
  ...
  print "  s = 0;"
  print ""
  print "bool TransSpec(Action a, SpecState s, SpecState t) a ~+ s"
  print "  !a.isInput &"
  print "  ("
  for(i=0; i<N; i++)
  ...
  print ""
  print "bool DeltaSpec(Action a, SpecState x, SpecState y) a<x, a<y"
  ...
  print ""
  print "bool DeltaSched(Action a, SchedState x, SchedState y) a<x, a<y"
  ...
  print "  bisimulates0(p1,p2) & bisimulates1(p1,p2);"
  print ""
