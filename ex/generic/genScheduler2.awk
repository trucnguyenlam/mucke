...
BEGIN {
  ...
  print "#print \""
  print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
  print "% this is the famous scheduler of Milner with forward analysis optimization   %"
  print "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
  print "\";"
  print "#print;"
  ...
  #print "  _Sched(a,s,t) assume ReachableSched(t);"
  print ""
  print "#print;"
  print "#timer reset; #timer go;"
  print "#print \"size of non simplified transition relation\";"
  print "#size _Sched;"
  print "#print \"size of *simplified* transition relation\";"
  print "#size Sched;"
  print "#print \"time for building transition relation is\";"
  print "#timer;"
  print "#print;"
  print ""
  print "#timer reset; #timer go;"
  ...
  ## print "#frontier off;"
  print "#print \"time for reachebelity analysis is\";"
  print "#timer;"
  print "#print;"
  print ""
