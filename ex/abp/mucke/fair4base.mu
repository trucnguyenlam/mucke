...
mu bool EGfair2_sender_not_get_Sender(State s)
  (
    ...
    |
    s.sender.state != get & 
    (exists State t. Trans(s,t) & EGfair2_sender_not_get_Sender(t))
  )
  & Reachable(s)
  ;
...
mu bool EGfair2_sender_not_get_Receiver(State s)
  (
    ...
    |
    s.sender.state != get & 
    (exists State t. Trans(s,t) & EGfair2_sender_not_get_Receiver(t))
  )
  & Reachable(s)
  ;
...
mu bool EGfair2_sender_not_get_S2R(State s)
  (
    ...
    |
    s.sender.state != get & 
    (exists State t. Trans(s,t) & EGfair2_sender_not_get_S2R(t))
  )
  & Reachable(s)
  ;
...
mu bool EGfair2_sender_not_get_R2S(State s)
  (
    ...
    |
    s.sender.state != get & 
    (exists State t. Trans(s,t) & EGfair2_sender_not_get_R2S(t))
  )
  & Reachable(s)
  ;
...
mu bool EGfair2_sender_not_get_S2Rfair(State s)
  (
    ((s.s2r.out.tag = data0 | s.s2r.out.tag = data1) & EGfair2_sender_not_get(s))
    |
    s.sender.state != get & 
    (exists State t. Trans(s,t) & EGfair2_sender_not_get_S2Rfair(t))
  )
  & Reachable(s)
  ;
